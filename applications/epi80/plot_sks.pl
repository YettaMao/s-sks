...
$offset_S = 0.1; # due to the low verlocity above the CMB
$offset_S_b = 0.04; # due to the low verlocity above the CMB
...
if($plot_raw==1){
   ...
   $comp1 = "r"; $comp2 = "t";
   $rawdir = "/home/zhl/work/s-sks/ncisp6/data/raw/2008_201_22_39_50/";
   chdir $rawdir;
