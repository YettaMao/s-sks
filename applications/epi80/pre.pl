...
$in = "ray_zl.in";
$sh_in = "ray_sh_zl.in";
$initial = "$home/applications/epi80/initial_model.pl";
$an_model= "$home/applications/epi80/iso2sem.pl";

$ray_par    = "s384_epi80.par";
$ray_sh_par = "s384_epi80_sh.par";
#$prem_par = "/home/zhl/work/aniso/code/rays/prem.par";
$prem_par = "prem_384.par";
