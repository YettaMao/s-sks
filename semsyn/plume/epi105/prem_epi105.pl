...
$homedir= "/home/zhl/work/rf/semsyn";
$psv    = "$homedir/bin/aserpsv_sem";
$demult = "$homedir/bin/demult";
$sem    = "$homedir/bin/sem2d";


$plotdir = "$homedir/plot";
$Plot_GRT_Directly= "$plotdir/plot/Plot_grt_directly.pl";
...
$plot_uvw = "$plotdir/plot_uvw_sks.pl";
$trace   = 30;
$cal_split="cal_split.pl";
