...
int
#ifdef FORTRAN
setpar_(xargv1,xargv2,dum1,dum2)
char *xargv1, *xargv2; int dum1,dum2;
#else
...
int ac; char **av;
#endif
   {
	...
	int ac; char **av;
/*
        extern char **__xargv_; extern int *__xargc__; 
        av[0]=(char *)malloc(dum1*sizeof(char));
        av[1]=(char *)malloc(dum2*sizeof(char));
*/

	ac =2;
	av = (char **) malloc(ac*sizeof(char));
	av[0]=xargv1; av[1]=xargv2;
#endif
