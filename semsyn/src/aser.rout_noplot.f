...
c     high generates response
  ...
  19   continue
  20   nquad=j
c For trying the start time , commented by Liang Zhao, Feb 18, 2006.
...
c   adds response to pp(from here to 99)
   ...
   32 continue
c For trying the start time , modified by Liang Zhao, Feb 18, 2006.
        write(*,300) td(1), tt(1)
  300 format (1x,'entire array before tt(1):',(e15.5,e15.5))
        return
   34 continue
        do 35 ii=1,nn
